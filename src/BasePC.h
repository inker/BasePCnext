		...
		for (int attempt = 0; attempt < 5; ++attempt) {
			try {
				...
				if (log.is_open()) {
					...
					log << "<tr><th colspan=2>����������� �������</th>" << endl;
					log << "<th colspan=6>���������� ��������� ���������� ����� ���������� �������</th>" << endl;
					log << "<th colspan=2>������, ���������� ���-� ���-�� ����� ���-��� �������</th></tr>" << endl;
					log << "<tr><td>�����</td><td>���</td><td>��</td><td>��</td><td>��</td><td>�</td><td>�</td><td>��</td><td>�����</td><td>�����</td></tr>" << endl;
					running = true;
